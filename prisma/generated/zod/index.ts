...
export const MemberLoansScalarFieldEnumSchema = z.enum(['loanId','memberId','loanType','sourceId','amountLoaned','amountPayable','interestRate','termInMonths','issueDate','dueDate','isExisting','journalRef']);
